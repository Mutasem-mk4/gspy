...
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -cc clang -target bpfel -type goroutine_meta -type syscall_event gspy ../../bpf/gspy.bpf.c -- -I/usr/include -I../../bpf -O2 -g -DBPF_NO_PRESERVE_ACCESS_INDEX
